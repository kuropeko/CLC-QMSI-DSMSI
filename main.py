...
if not st.session_state.logged_in:
    # Login page: no scroll, vertically centered
    st.markdown("""
    <style>
    /* Hide "Press Enter to submit form" */
    [data-testid="InputInstructions"] { display: none !important; }

    /* Remove all scrolling on login page */
    html, body {
    ...
    /* Remove default top padding on login */
    .block-container {
    ...
    # Main app: normal scroll + hide Enter hint
    st.markdown("""
    <style>
    /* Hide "Press Enter to submit form" */
    [data-testid="InputInstructions"] { display: none !important; }

    /* Equal-width rename/delete buttons */
    [data-testid="stSidebar"] .manage-row > div {
        flex: 1;
        min-width: 0;
    }
...
def main_app():
    ...
    def load_metadata():
        meta_file = os.path.join(os.path.dirname(TRACKER_FILE), "metadata.json")
